    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form action="<?= ADMIN_URL . 'room_services/save-add.php' ?>" method="post" id="add-service-form" enctype="multipart/form-data">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="icon" onchange="encodeImageFileAsURL(this)" class="custom-file-input">
