        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Sửa Cài Đặt</h1>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                <form action="<?= ADMIN_URL . 'web_settings/save-edit.php' ?>" method="post" id="edit-web-form" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= $web['id'] ?>" id="">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="">Tên</label>
                                            <input type="text" name="name" class="form-control" value="<?= $web['name'] ?>">
                                            <?php if (isset($_GET['nameerr'])) : ?><label for="" class="error"><?= $_GET['nameerr'] ?></label>
                                            <?php endif ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Số điện thoại</label>
                                            <input type="text" name="phone" class="form-control" value="<?= $web['phone_number'] ?>">
                                            <?php if (isset($_GET['phoneerr'])) : ?><label for="" class="error"><?= $_GET['phoneerr'] ?></label>
                                            <?php endif ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Địa chỉ</label>
                                            <input type="text" name="address" class="form-control" value="<?= $web['address'] ?>">
                                            <?php if (isset($_GET['addresserr'])) : ?><label for="" class="error"><?= $_GET['addresserr'] ?></label>
                                            <?php endif ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Email</label>
                                            <input type="text" name="email" class="form-control" value="<?= $web['email'] ?>">
                                            <?php if (isset($_GET['emailerr'])) : ?><label for="" class="error"><?= $_GET['emailerr'] ?></label>
                                            <?php endif ?>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Map_URL</label>
                                            <input type="text" name="map" class="form-control" value="<?= $web['map_url'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Facebook_URL</label>
                                            <input type="text" name="fb" class="form-control" value="<?= $web['facebook_url'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Twitter_URL</label>
                                            <input type="text" name="tt" class="form-control" value="<?= $web['twitter_url'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Instagram_URL</label>
                                            <input type="text" name="ins" class="form-control" value="<?= $web['instagram_url'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="">GooglePlus_URL</label>
                                            <input type="text" name="gg" class="form-control" value="<?= $web['googleplus_url'] ?>">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-5 offset-md-3">
                                                    <img src="<?= BASE_URL . $web['logo'] ?>" id="preview-img" class="img-fluid">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option <?php if ($web['status'] == 1) : ?> selected <?php endif ?> value="1">Hoạt động</option>
                                                <option <?php if ($web['status'] == 0) : ?> selected <?php endif ?> value="0">Không hoạt động</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
